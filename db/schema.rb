...
ActiveRecord::Schema.define(version: 20160912143346) do
  ...
  create_table "audit_views", force: :cascade do |t|
    t.integer  "user_id"
    t.datetime "datetime"
    t.integer  "audit_id"
  end
  ...
  create_table "exit_condition_views", force: :cascade do |t|
    t.integer  "user_id"
    t.datetime "datetime"
    t.integer  "exit_condition_id"
  end

  create_table "exit_conditions", force: :cascade do |t|
    t.integer  "step_id"
  ...
  add_index "file_references", ["tree_id"], name: "index_file_references_on_tree_id", using: :btree
  ...
  add_index "node_contents", ["node_id"], name: "index_node_contents_on_node_id", using: :btree

  create_table "node_views", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "node_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_index "org_subscriptions", ["organisation_id"], name: "index_org_subscriptions_on_organisation_id", using: :btree
  add_index "org_subscriptions", ["user_id"], name: "index_org_subscriptions_on_user_id", using: :btree
  ...
  create_table "step_views", force: :cascade do |t|
    t.integer  "user_id"
    t.datetime "datetime"
    t.integer  "step_id"
  end
  ...
  add_index "steps", ["audit_id"], name: "index_steps_on_audit_id", using: :btree
  ...
  add_index "tags", ["audit_id"], name: "index_tags_on_audit_id", using: :btree
  add_index "tags", ["name", "audit_id"], name: "index_tags_on_name_and_audit_id", unique: true, using: :btree
  ...
  create_table "treeviews", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "tree_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  add_foreign_key "file_references", "trees"
end
